  ...
  it('validates official source URL domains by source type', () => {
    const issues = validateReferenceUrlPolicy({
      ...
      sources: [
        ...
        { id: 'src_moel_ok', type: 'MOEL_GUIDE', url: 'https://www.moel.go.kr/news/enews/report/enewsView.do?news_seq=18144' },
    ...
    expect(issues.map((issue) => issue.id)).not.toContain('src_moel_ok')
